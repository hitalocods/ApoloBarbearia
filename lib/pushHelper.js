...
const DEFAULT_VAPID_PUB = 'BEiereOENb_vK1OiCUptsfKyZsWOZNFIicE36soiAOGEgkC4y-rF7-Yqy2hizoJYp-JXZnC-1VD-H7bbDJkHGio';
const DEFAULT_VAPID_PRIV = 'qCz3AgGTHjGrpxLSaBJhpsGozCwx0mTPExXkcHWnOUc';
const DEFAULT_VAPID_SUB = 'mailto:contato@apolobarbearia.com.br';

const vapidPublicKey = process.env.VAPID_PUBLIC_KEY || DEFAULT_VAPID_PUB;
const vapidPrivateKey = process.env.VAPID_PRIVATE_KEY || DEFAULT_VAPID_PRIV;
const vapidSubject = process.env.VAPID_SUBJECT || DEFAULT_VAPID_SUB;
